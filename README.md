...
```bash
git clone https://github.com/YOUR_USERNAME/memory-augmentation-rag.git
cd memory-augmentation-rag
```
...
The Hugging Face token is required for gated models and diarization pipelines.
